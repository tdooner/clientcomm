...
exports.up = function (knex, Promise) {
  return Promise.all([
    ...
    knex.schema.createTable('cms', (table) => {
    ...
    knex.schema.createTable('convos', (table) => {
    ...
    knex.schema.createTable('msgs', (table) => {
    ...
    knex.schema.createTable('commconns', (table) => {
    ...
    knex.schema.createTable('comms', (table) => {
