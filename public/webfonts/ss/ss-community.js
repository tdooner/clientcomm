...
if (/(MSIE [7-9]\.|Opera.*Version\/(10\.[5-9]|(11|12)\.)|Chrome\/([1-9]|10)\.|Version\/[2-4][\.0-9]+ Safari\/|Version\/(4\.0\.[4-9]|4\.[1-9]|5\.0)[\.0-9]+? Mobile\/.*Safari\/|Android ([1-2]|4\.[2-9].*Version\/4)\.|BlackBerry.*WebKit)/.test(navigator.userAgent) && !/(IEMobile)/.test(navigator.userAgent)) {
  ...
  if (typeof ss_legacy !== 'function') {
    /* domready.js */
    !(function (a, b) { typeof module !== 'undefined' ? module.exports = b() : typeof define === 'function' && typeof define.amd === 'object' ? define(b) : this[a] = b(); }('ss_ready', (a) => {
      function m(a) { l = 1; while (a = b.shift())a(); } var b = [],
        ...
        k = 'readyState',
        l = /^loade|c/.test(e[k]); return e[i] && e[i](h, c = function () { e.removeEventListener(h, c, d), m(); }, d), g && e.attachEvent(j, c = function () { /^c/.test(e[k]) && (e.detachEvent(j, c), m()); }), a = g ? function (c) { self != top ? l ? c() : b.push(c) : (function () { try { f.doScroll('left'); } catch (b) { return setTimeout(() => { a(c); }, 50); }c(); }()); } : function (a) { l ? a() : b.push(a); };
    }));
    ...
    const ss_getElementsByClassName = function (node, classname) {
    ...
    var ss_liga = function (that) {
      const re = new RegExp(ss_keywords.join('|').replace(/[-[\]{}()*+?.,\\^$#\s]/g, '\\$&'), 'gi');
      return that.replace(re, v => ss_icons[v.toLowerCase()]);
    };
