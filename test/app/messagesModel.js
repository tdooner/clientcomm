...
describe('Messages checks', () => {
  ...
  it('should be able to Messages.sendOne email', (done) => {
  	mock.enable();
  	let communication,
    conversation;
  	...
  	}).then(conversation => Messages.sendOne(communication.commid, 'hi', conversation)).then(messages => Messages.where({ content: 'hi', tw_sid: '<2013FAKE82626.18666.16540@clientcomm.org>' })).then((messages) => {
